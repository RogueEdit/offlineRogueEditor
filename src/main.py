...
if __name__ == '__main__':
    ...
    while True:
        print('')
        cFormatter.print(Color.GREEN, '<pyRogue Offline>')


            
        func = {
            '1': rogue.edit_starter_separate,
        ...
        term = [
            ...
            f'8: Add candies to a pokemon{" " * 22}{formatted_working_status}',
            f'9: Edit money amount{" " * 29}{formatted_working_status}',
            ...
            f'24: >> Print help and program information{" " * 17}' + Fore.LIGHTYELLOW_EX + Style.BRIGHT +'(Use when done)' + Style.RESET_ALL,
            f'{formatted_title}',
        ]
