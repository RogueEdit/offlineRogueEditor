...
class Rogue:
    ...
    def __init__(self) -> None:
        ...
        self.__trainer_filename = "data_Guest.json"
        self.__gamedata_filename = "sessionData_Guest.json"
    ...
    def print_help(self) -> None:
        ...
        print(Fore.LIGHTYELLOW_EX + Style.BRIGHT + "https://github.com/RogueEdit/offlineRogueEditor/.")
        print(Fore.LIGHTYELLOW_EX + Style.BRIGHT + "This is release version v0.1.1 - please include that in your issue or question report.")
        ...
        print(Fore.LIGHTYELLOW_EX + Style.BRIGHT + "calculate the checksum of this binary and visit https://github.com/RogueEdit/offlineRogueEditor/")
